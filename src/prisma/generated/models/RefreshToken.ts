...
export type RefreshTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"tokenHash" | "userId" | "createdAt" | "expiresAt" | "replacedBy" | "revoked", ExtArgs["result"]["refreshToken"]>
...
export interface RefreshTokenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Update zero or more RefreshTokens and only return the `tokenHash`
   * const refreshTokenWithTokenHashOnly = await prisma.refreshToken.updateManyAndReturn({
   *   select: { tokenHash: true },
   *   where: {
   *     // ... provide filter here
   *   },
